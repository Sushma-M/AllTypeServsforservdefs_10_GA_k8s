...
public class ProductsServiceImpl implements ProductsService {
    ...
    public Products create(Products products) {
        ...
        List<Orderdetails> orderdetailses = products.getOrderdetailses();
        if(orderdetailses != null && Hibernate.isInitialized(orderdetailses)) {
            orderdetailses.forEach(_orderdetails -> _orderdetails.setProducts(products));
        }
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service classicmodels for table Products to {} format", options.getExportType());
