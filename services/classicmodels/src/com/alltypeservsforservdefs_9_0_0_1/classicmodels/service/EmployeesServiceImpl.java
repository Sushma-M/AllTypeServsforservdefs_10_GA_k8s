...
public class EmployeesServiceImpl implements EmployeesService {
    ...
    public Employees create(Employees employees) {
        ...
        List<Customers> customerses = employees.getCustomerses();
        List<Employees> employeesesForReportsTo = employees.getEmployeesesForReportsTo();
        if(customerses != null && Hibernate.isInitialized(customerses)) {
            customerses.forEach(_customers -> _customers.setEmployees(employees));
        }
        if(employeesesForReportsTo != null && Hibernate.isInitialized(employeesesForReportsTo)) {
            employeesesForReportsTo.forEach(_employees -> _employees.setEmployeesByReportsTo(employees));
        }
