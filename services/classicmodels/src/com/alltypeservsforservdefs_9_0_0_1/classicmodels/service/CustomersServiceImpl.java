...
public class CustomersServiceImpl implements CustomersService {
    ...
    public Customers create(Customers customers) {
        ...
        List<Orders> orderses = customers.getOrderses();
        List<Payments> paymentses = customers.getPaymentses();
        if(orderses != null && Hibernate.isInitialized(orderses)) {
            orderses.forEach(_orders -> _orders.setCustomers(customers));
        }
        if(paymentses != null && Hibernate.isInitialized(paymentses)) {
            paymentses.forEach(_payments -> _payments.setCustomers(customers));
        }
