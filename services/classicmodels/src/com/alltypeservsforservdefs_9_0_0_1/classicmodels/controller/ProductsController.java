...
public class ProductsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Products editProducts(@PathVariable("id") String id, @RequestBody Products products) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Orderdetails> findAssociatedOrderdetailses(@PathVariable("id") String id, Pageable pageable) {

        LOGGER.debug("Fetching all associated orderdetailses");
        return productsService.findAssociatedOrderdetailses(id, pageable);
    }
